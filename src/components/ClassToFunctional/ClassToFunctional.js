...
const SupportParameterSchematic = (props) => {
  ...
  // instead of contructor and state object

  const [spUri, setSpUri] = useState(null);

  // this useEffect is componentDidmount / componentWillUnmount
  useEffect(() => {
  ...
  // this useEffect is componentDidUpdate / componentWillReceiveProps
  useEffect(() => {
